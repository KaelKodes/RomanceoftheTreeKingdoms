...
public partial class MainMenu : Control
{
    ...
    private void ResetWorldData()
    {
        ...
        string rootPath = System.IO.Path.GetFullPath(System.IO.Path.Combine(projectPath, "../"));
        string scriptPath = System.IO.Path.Combine(rootPath, "tools/seed_db.py");
        string pythonExe = "python"; // Assuming in PATH

        ProcessStartInfo startInfo = new ProcessStartInfo();
        startInfo.FileName = pythonExe;
        startInfo.Arguments = $"\"{scriptPath}\"";
        startInfo.WorkingDirectory = rootPath; // Ensure Python runs from project root
