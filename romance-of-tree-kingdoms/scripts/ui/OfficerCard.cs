...
public partial class OfficerCard : Window
{
    ...
    private void Refresh()
    {
        ...
        using (var conn = new SqliteConnection($"Data Source={dbPath}"))
        {
            ...
            cmd.CommandText = @"
                SELECT o.name, f.name, o.leadership, o.intelligence, o.strength, o.politics, f.leader_id, o.faction_id, o.rank, o.is_commander, o.reputation, o.battles_won, o.charisma
                FROM officers o
            ...
            using (var r = cmd.ExecuteReader())
            {
                if (r.Read())
                {
                    ...
                    int cha = r.IsDBNull(12) ? 50 : r.GetInt32(12);
                    ...
                    int rank = r.IsDBNull(8) ? 0 : r.GetInt32(8);
                    bool isGov = !r.IsDBNull(9) && r.GetBoolean(9);
                    int rep = r.IsDBNull(10) ? 0 : r.GetInt32(10);
                    int wins = r.IsDBNull(11) ? 0 : r.GetInt32(11);
                    ...
                    _nameLabel.Text = $"{name}\n{faction}\nRank: {GameConstants.GetRankTitle(rank)} | {titleStr}\nReputation: {rep} | Wins: {wins}";
